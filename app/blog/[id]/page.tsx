									...
									<div className="col-lg-12">
										<div className="main-heading">
											<div className="page-prog">
												...
												<p>Blog</p>
												<span><i className="fa-solid fa-angle-right" /></span>
												<p className="bold">Blog Details Standard</p>
											</div>
											<h1>Standard</h1>
										</div>
									</div>
									...
									<div className="col-lg-12">
										<div className="blog-page3-single-box">
												...
												<div className="social-area mb-16">
													<div className="author-area">
														<div className="author">
															...
															<Link href="/author" className="author-text">{blogPost.author}</Link>
														</div>
														<div className="date">
											...
											<div className="thumbnail image-anime _relative mt-20">
												<img src="/assets/img/blog/blog-details-image1.png" alt="vexon" />
											</div>
										</div>
									</div>
								</div>
													...
													<div className="heading-area">
														<div className="_author-area">
															<div className="author">
																...
																<Link href="/author" className="author-name">Lorri Warf</Link>
															</div>
															<Link href="/#" className="date"><img src="/assets/img/icons/date1.svg" alt="vexon" /> Oct 21, 2025</Link>
														</div>
												...
												<div className="sidebar-single-slider">
													...
													<div className="heading-area">
														<div className="_author-area">
															...
															<Link href="/author" className="date"><img src="/assets/img/icons/date1.svg" alt="vexon" /> Oct 21, 2025</Link>
														</div>
														<h4><Link href="/blog-single">Handling Negative Feedback: Maintaining Brand Reputation on Social Media</Link></h4>
													</div>
												</div>
